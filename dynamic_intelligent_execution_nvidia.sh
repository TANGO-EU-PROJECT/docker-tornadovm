...
if [ $# -eq 0 ]; then
	...
	$TORNADO_DOCKER_SCRIPT/polyglotImages/polyglot-graalpy/tornadovm-polyglot-nvidia.sh tornado-test -V uk.ac.manchester.tornado.unittests.profiler.TestProfiler
